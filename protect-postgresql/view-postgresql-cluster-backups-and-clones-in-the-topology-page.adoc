...
. Wenn Sie einen Klon teilen möchten, wählen Sie den Klon aus der Tabelle aus und klicken Sie dann auf image:../media/split_cone.gif["Symbol für „Split klonen“"].
