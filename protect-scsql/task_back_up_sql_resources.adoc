...
+
Sie können eine Richtlinie erstellen, indem Sie * * auswählenimage:../media/add_policy_from_resourcegroup.gif[""], um den Richtlinien-Assistenten zu starten.
...
.. Wählen Sie die Richtlinie aus, für die Sie Ihren Überprüfungsplan konfigurieren möchten, und wählen Sie dann * *image:../media/add_policy_from_resourcegroup.gif[""]aus.
