...
|===
Der SnapCenter-Agent bietet Builders (https://en.wikipedia.org/wiki/Builder_pattern["Baumuster"]) für alle seine Ergebnistypen an. Daher ist es sehr einfach, sie zu verwenden:
