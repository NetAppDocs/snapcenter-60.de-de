...
NOTE: Sie können eine Richtlinie auch erstellen, indem Sie * * auswählenimage:../media/add_policy_from_resourcegroup.gif["Ein Plus-Symbol"].

+
Die Richtlinien sind im Abschnitt * Zeitpläne für ausgewählte Richtlinien konfigurieren* aufgeführt.

.. Wählen Sie in der Spalte *Configure Schedules* * für die Richtlinie ausimage:../media/add_policy_from_resourcegroup.gif["Ein Plus-Symbol"], die Sie konfigurieren möchten.
