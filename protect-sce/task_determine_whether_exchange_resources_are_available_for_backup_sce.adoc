...
+
Klicken Sie auf image:../media/filter_icon.png["Filtersymbol"] , und wählen Sie den Hostnamen und den Exchange Server aus, um die Ressourcen zu filtern. Sie können dann klicken image:../media/filter_icon.png["Filtersymbol"] , um den Filterbereich zu schließen.
